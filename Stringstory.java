...
public class Stringstory {
	public static void main(String[] args) {
		...
		String Stringstory = "This morning "+name1+" woke up feeling "
		...
		+verb1+" to the rhythm of the "+noun3+", which made all the "+noun4+"s very "
				+adjective3+". Concerned, "+name1+" texted "+name2+", who flew "+name1+" "
						+ "to "+place1+" and dropped "+name1+" in a puddle of frozen "+
				noun5+". "+name1+" woke up in the year "+number+", in a world where "+noun6+
				"s ruled the world.";
